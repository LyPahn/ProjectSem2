...
<head>
    ...
    <style>
        .ck-editor__editable_inline {
            min-height: 200px; /* Thay đổi giá trị này theo ý bạn */
        }
    </style>
</head>
                ...
                <ul class="sa-nav sa-nav--sidebar" data-sa-collapse="">
                    <li class="sa-nav__section">
                        ...
                        <ul class="sa-nav__menu sa-nav__menu--root">
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a href="index.html"
                            ...
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link"
                                    ...
                                    viewBox="0 0 16 16" fill="currentColor">
                                            ...
                                            </svg></span><span class="sa-nav__title">Danh mục</span><span
                                ...
                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                    <li class="sa-nav__menu-item"><a href="${contextPath}/admin/product"
                                                                     class="sa-nav__link"><span
                                            class="sa-nav__menu-item-padding"></span><span
                                            class="sa-nav__title">Products List</span></a></li>
                                    <li class="sa-nav__menu-item"><a href="${contextPath}/admin/category"
                                                                     class="sa-nav__link"><span
                                            class="sa-nav__menu-item-padding"></span><span
                                            class="sa-nav__title">Categories List</span></a></li>
                                    <li class="sa-nav__menu-item"><a href="${contextPath}/admin/brand"
                                                                     class="sa-nav__link"><span
                                            class="sa-nav__menu-item-padding"></span><span
                                            class="sa-nav__title">Brands list</span></a></li>
                                </ul>
                            </li>
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                data-sa-collapse-item="sa-nav__menu-item--open"><a href="#" class="sa-nav__link"
                ...
                <div class="sa-toolbar__item dropdown"><button class="sa-toolbar__button" type="button"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                src="${contextPath}/resources/admin/vendor/flag-icons/24/DE.png" class="sa-language-icon me-3" alt="" /><span
                                class="ps-2">German</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                src="${contextPath}/resources/admin/vendor/flag-icons/24/FR.png" class="sa-language-icon me-3" alt="" /><span
                                class="ps-2">French</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                src="${contextPath}/resources/admin/vendor/flag-icons/24/GB.png" class="sa-language-icon me-3" alt="" /><span
                                class="ps-2">English</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                src="${contextPath}/resources/admin/vendor/flag-icons/24/RU.png" class="sa-language-icon me-3" alt="" /><span
                                class="ps-2">Russian</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                src="${contextPath}/resources/admin/vendor/flag-icons/24/IT.png" class="sa-language-icon me-3" alt="" /><span
