...
<c:set var="contextPath" value="${pageContext.servletContext.contextPath}" scope="session" />
    <div id="top" class="sa-app__body">
        <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
            ...
            <form:form action="${contextPath}/admin/category/edit-category" method="post" modelAttribute="category" enctype="multipart/form-data">
                <form:hidden path="id"/>
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-auto d-flex">
                            <button class="btn btn-primary">Cập nhật</button></div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <form:input type="text" class="form-control" id="form-category/name" value="${category.cateName}" path="cateName"/>
                                    </div>
                                </div>
                                <div class="mb-5">
